...
namespace AMI.Neitsillia.NeitsilliaCommands.Social
{
    class ItemOffer
    {
        ...
        internal static ItemOffer IdLoad(Guid id) => AMYPrototype.Program.
            data.database.LoadRecord("Offer", MongoDatabase.FilterEqual<ItemOffer, Guid>("_id", id));
